...
inline ::v1::model::Odometry* Localization::_internal_mutable_odometry() {
  ...
  if (odometry_ == nullptr) {
    auto* p = CreateMaybeMessage<::v1::model::Odometry>(GetArena());
    odometry_ = p;
  }
  return odometry_;
}
...
inline ::v1::model::Map* Localization::_internal_mutable_map() {
  ...
  if (map_ == nullptr) {
    auto* p = CreateMaybeMessage<::v1::model::Map>(GetArena());
    map_ = p;
  }
  return map_;
}
...
inline ::v1::model::Path* Localization::_internal_mutable_path() {
  ...
  if (path_ == nullptr) {
    auto* p = CreateMaybeMessage<::v1::model::Path>(GetArena());
    path_ = p;
  }
  return path_;
}
...
inline ::v1::model::Goal* Localization::_internal_mutable_goal() {
  ...
  if (goal_ == nullptr) {
    auto* p = CreateMaybeMessage<::v1::model::Goal>(GetArena());
    goal_ = p;
  }
  return goal_;
}
...
inline ::v1::model::Twist* Odometry::_internal_mutable_twist() {
  ...
  if (twist_ == nullptr) {
    auto* p = CreateMaybeMessage<::v1::model::Twist>(GetArena());
    twist_ = p;
  }
  return twist_;
}
...
inline ::v1::model::OccupancyGrid* Map::_internal_mutable_occupancy_grid() {
  if (!_internal_has_occupancy_grid()) {
    clear_data();
    set_has_occupancy_grid();
    data_.occupancy_grid_ = CreateMaybeMessage< ::v1::model::OccupancyGrid >(GetArena());
  }
...
inline std::string* Map::unsafe_arena_release_url() {
  // @@protoc_insertion_point(field_unsafe_arena_release:v1.model.Map.url)
...
inline void Map::unsafe_arena_set_allocated_url(std::string* url) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (!_internal_has_url()) {
    data_.url_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:v1.model.Map.url)
}
...
inline void Map::set_raw(const void* value,
                             size_t size) {
  if (!_internal_has_raw()) {
    clear_data();
    set_has_raw();
...
inline std::string* Map::unsafe_arena_release_raw() {
  // @@protoc_insertion_point(field_unsafe_arena_release:v1.model.Map.raw)
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (_internal_has_raw()) {
    clear_has_data();
...
inline void Map::unsafe_arena_set_allocated_raw(std::string* raw) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (!_internal_has_raw()) {
    data_.raw_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:v1.model.Map.raw)
}
...
inline std::string* GoalID::unsafe_arena_release_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:v1.model.GoalID.id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void GoalID::unsafe_arena_set_allocated_id(
    std::string* id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (id != nullptr) {
  ...
  id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:v1.model.GoalID.id)
}
