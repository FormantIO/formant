...
class Datapoint PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void unsafe_arena_set_allocated_metric_set(
      ::v1::model::MetricSet* metric_set);
  ::v1::model::MetricSet* unsafe_arena_release_metric_set();
...
inline std::string* Datapoint::unsafe_arena_release_stream() {
  // @@protoc_insertion_point(field_unsafe_arena_release:v1.model.Datapoint.stream)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return stream_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Datapoint::unsafe_arena_set_allocated_stream(
    std::string* stream) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (stream != nullptr) {
  ...
  stream_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      stream, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:v1.model.Datapoint.stream)
}
...
inline ::v1::model::Text* Datapoint::_internal_mutable_text() {
  if (!_internal_has_text()) {
    clear_data();
    set_has_text();
    data_.text_ = CreateMaybeMessage< ::v1::model::Text >(GetArena());
  }
  return data_.text_;
}
...
inline ::v1::model::MetricSet* Datapoint::unsafe_arena_release_metric_set() {
  // @@protoc_insertion_point(field_unsafe_arena_release:v1.model.Datapoint.metric_set)
  if (_internal_has_metric_set()) {
    clear_has_data();
    ::v1::model::MetricSet* temp = data_.metric_set_;
    data_.metric_set_ = nullptr;
...
inline void Datapoint::unsafe_arena_set_allocated_metric_set(::v1::model::MetricSet* metric_set) {
  clear_data();
  if (metric_set) {
    set_has_metric_set();
    data_.metric_set_ = metric_set;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:v1.model.Datapoint.metric_set)
}
inline ::v1::model::MetricSet* Datapoint::_internal_mutable_metric_set() {
  if (!_internal_has_metric_set()) {
    clear_data();
    set_has_metric_set();
    data_.metric_set_ = CreateMaybeMessage< ::v1::model::MetricSet >(GetArena());
  }
...
inline ::v1::model::Bitset* Datapoint::_internal_mutable_bitset() {
  if (!_internal_has_bitset()) {
    clear_data();
    set_has_bitset();
    data_.bitset_ = CreateMaybeMessage< ::v1::model::Bitset >(GetArena());
  }
...
inline ::v1::model::File* Datapoint::_internal_mutable_file() {
  if (!_internal_has_file()) {
    clear_data();
    set_has_file();
    data_.file_ = CreateMaybeMessage< ::v1::model::File >(GetArena());
  }
  return data_.file_;
}
...
inline ::v1::model::PointCloud* Datapoint::_internal_mutable_point_cloud() {
  if (!_internal_has_point_cloud()) {
    clear_data();
    set_has_point_cloud();
    data_.point_cloud_ = CreateMaybeMessage< ::v1::model::PointCloud >(GetArena());
  }
...
inline ::v1::model::Location* Datapoint::_internal_mutable_location() {
  if (!_internal_has_location()) {
    clear_data();
    set_has_location();
    data_.location_ = CreateMaybeMessage< ::v1::model::Location >(GetArena());
  }
...
inline ::v1::model::Localization* Datapoint::_internal_mutable_localization() {
  if (!_internal_has_localization()) {
    clear_data();
    set_has_localization();
    data_.localization_ = CreateMaybeMessage< ::v1::model::Localization >(GetArena());
  }
...
inline ::v1::model::Health* Datapoint::_internal_mutable_health() {
  if (!_internal_has_health()) {
    clear_data();
    set_has_health();
    data_.health_ = CreateMaybeMessage< ::v1::model::Health >(GetArena());
  }
...
inline ::v1::model::Json* Datapoint::_internal_mutable_json() {
  if (!_internal_has_json()) {
    clear_data();
    set_has_json();
    data_.json_ = CreateMaybeMessage< ::v1::model::Json >(GetArena());
  }
  return data_.json_;
}
