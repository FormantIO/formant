...
_SELECTIONRESPONSE = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_value', full_name='v1.model.SelectionResponse._value',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_SELECTIONRESPONSE.oneofs_by_name['_value'].fields.append(
  _SELECTIONRESPONSE.fields_by_name['value'])
_SELECTIONRESPONSE.fields_by_name['value'].containing_oneof = _SELECTIONRESPONSE.oneofs_by_name['_value']
